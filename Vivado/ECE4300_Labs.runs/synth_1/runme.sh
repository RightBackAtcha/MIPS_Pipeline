...
HD_PWD='C:/Users/Jorda/4300_Lab1/4300_Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I_FETCH.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I_FETCH.tcl
