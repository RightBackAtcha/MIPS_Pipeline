...
HD_PWD='C:/Users/Jorda/4300_Lab1/4300_Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log I_FETCH.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source I_FETCH.tcl -notrace
